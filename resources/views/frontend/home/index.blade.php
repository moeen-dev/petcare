	...
	<div id="header-carousel" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
				<img class="w-100" src="{{ url('upload/images', $banner->image) }}" alt="Image">
				<div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
					<div class="p-3" style="max-width: 900px;">
						<h3 class="text-white mb-3 d-none d-sm-block">{{ $banner->tagLine }}</h3>
						<h1 class="display-3 text-white mb-3">{{ $banner->title }}</h1>
						<h5 class="text-white mb-3 d-none d-sm-block">{{ $banner->shortText }}</h5>
...
<div class="container py-5">
	<div class="row py-5">
		<div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
			...
			<p>{{ \Illuminate\Support\Str::limit(strip_tags($abouts->description), 1500) }}.....</p>
			<a href="{{ route('about')}}" class="btn btn-lg btn-primary mt-3 px-4">Learn More</a>
		</div>
		<div class="col-lg-5">
			<div class="row px-3">
			...
			<div class="col-lg-4 mb-4">
				<div class="card border-0">
					<div class="card-header position-relative border-0 p-0 mb-4">
						<img class="card-img-top" src="{{ url('assets/frontend/img/price-1.jpg') }}" alt="">
					...
					<div class="card-footer border-0 p-0">
						<a class="btn btn-primary btn-block p-3" style="border-radius: 0;">Up Coming</a>
					</div>
				</div>
			</div>
			<div class="col-lg-4 mb-4">
				<div class="card border-0">
					<div class="card-header position-relative border-0 p-0 mb-4">
						<img class="card-img-top" src="{{ url('assets/frontend/img/price-2.jpg') }}" alt="">
						<div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style="top: 0; left: 0; z-index: 1; background: rgba(0, 0, 0, .5);">
					...
					<div class="card-footer border-0 p-0">
						<a class="btn btn-secondary btn-block p-3" style="border-radius: 0;">Up Coming</a>
					</div>
				</div>
			</div>
			<div class="col-lg-4 mb-4">
				<div class="card border-0">
					<div class="card-header position-relative border-0 p-0 mb-4">
						<img class="card-img-top" src="{{ url('assets/frontend/img/price-3.jpg') }}" alt="">
						<div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style="top: 0; left: 0; z-index: 1; background: rgba(0, 0, 0, .5);">
	...
	<div class="row">
		...
		<div class="col-lg-3 col-md-6">
			<div class="team card position-relative overflow-hidden border-0 mb-4">
				<img class="card-img-top" src="{{ url('upload/images', $team->image) }}" alt="team_image_pet_care">
				<div class="card-body text-center p-0">
					...
					<div class="team-social d-flex align-items-center justify-content-center bg-dark">
						<a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" target="_blank" href="{{ $team->x_url }}"><i class="fab fa-twitter"></i></a>

						<a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" target="_blank" href="{{ $team->facebook_url }}"><i class="fab fa-facebook-f"></i></a>

						<a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" target="_blank" href="{{ $team->linkedin_url }}"><i class="fab fa-linkedin-in"></i></a>

						<a class="btn btn-outline-primary rounded-circle text-center px-0" style="width: 36px; height: 36px;" target="_blank" href="{{ $team->instagram_url }}"><i class="fab fa-instagram"></i></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="container pt-5">
	<div class="d-flex flex-column text-center mb-5">
		...
		<h1 class="display-4 m-0"><span class="text-primary">Latest</span> From Blog</h1>
	</div>
	<div class="row pb-3">
